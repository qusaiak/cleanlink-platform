...
class $AssetsImagesSearchGen {
  ...
  /// File path: assets/images/search/categories.jpg
  AssetGenImage get categories => const AssetGenImage('assets/images/search/categories.jpg');

  /// File path: assets/images/search/companies.jpg
  AssetGenImage get companies => const AssetGenImage('assets/images/search/companies.jpg');

  /// File path: assets/images/search/offers.jpg
  AssetGenImage get offers => const AssetGenImage('assets/images/search/offers.jpg');

  /// File path: assets/images/search/regions.jpg
  AssetGenImage get regions => const AssetGenImage('assets/images/search/regions.jpg');

  /// File path: assets/images/search/services.jpg
  AssetGenImage get services => const AssetGenImage('assets/images/search/services.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [categories, companies, offers, regions, services];
}
...
class $AssetsImagesTestGen {
  ...
  /// File path: assets/images/test/worker.jpg
  AssetGenImage get worker => const AssetGenImage('assets/images/test/worker.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [test, worker];
}
...
class Assets {
  ...
  static const String localConfig = 'local_config.env';

  /// List of all assets
  static List<String> get values => [localConfig];
}
