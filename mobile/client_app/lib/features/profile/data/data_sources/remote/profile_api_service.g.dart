...
class _ProfileApiService implements ProfileApiService {
  ...
  Future<HttpResponse<UpdateProfileResponseModel>> updateProfile(
    ...
    final _options = _setStreamType<HttpResponse<UpdateProfileResponseModel>>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
  ...
  @override
  Future<HttpResponse<LogoutResponseModel>> logout() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<DashboardSummaryResponseModel>>
  getDashboardSummary() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<DashboardSummaryResponseModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DashboardSummaryResponseModel _value;
    try {
      _value = DashboardSummaryResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<LogoutResponseModel>> deleteAccount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
