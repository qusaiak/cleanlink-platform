...
class _AuthApiService implements AuthApiService {
  ...
  Future<HttpResponse<BaseResponseModel<AuthResponseModel>>> login(
    ...
    final _options =
        _setStreamType<HttpResponse<BaseResponseModel<AuthResponseModel>>>(
    ...
    late BaseResponseModel<AuthResponseModel> _value;
    try {
      _value = BaseResponseModel<AuthResponseModel>.fromJson(
        _result.data!,
  ...
  updateProfile(File? image, String address, String phone) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponseModel<UserProfileResponseModel> _value;
    try {
      _value = BaseResponseModel<UserProfileResponseModel>.fromJson(
        _result.data!,
        (json) =>
