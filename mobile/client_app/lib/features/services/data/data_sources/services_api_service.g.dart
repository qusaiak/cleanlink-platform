...
class _ServicesApiService implements ServicesApiService {
  _ServicesApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<ServicesResponseModel>> getServices() async {
    ...
    late ServicesResponseModel _value;
    try {
      _value = ServicesResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<ServiceDetailsResponseModel>> getServiceDetails(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ServiceDetailsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'services/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ServiceDetailsResponseModel _value;
    try {
      _value = ServiceDetailsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
