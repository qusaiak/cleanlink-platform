...
class _ReviewsApiService implements ReviewsApiService {
  ...
  Future<HttpResponse<ReviewResponseModel>> addReview(
    ...
    final _options = _setStreamType<HttpResponse<ReviewResponseModel>>(
  ...
  @override
  Future<HttpResponse<MyReviewsResponseModel>> getMyReviews() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<MyReviewsResponseModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MyReviewsResponseModel _value;
    try {
      _value = MyReviewsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
