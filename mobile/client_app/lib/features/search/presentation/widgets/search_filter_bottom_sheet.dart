...
class _SearchFilterBottomSheetState extends State<SearchFilterBottomSheet> {
  ...
  Widget _buildDistanceSlider(ColorScheme theme) {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  void _applyFilters() {
    ...
    bloc.add(UpdateAvailability(_availability));
    bloc.add(UpdateSortOrder(_sortOrder));
    bloc.add(UpdatePriceRange(_priceRange));
    bloc.add(UpdateDistance(_distance));
    bloc.add(UpdateMinRate(_minRate));
